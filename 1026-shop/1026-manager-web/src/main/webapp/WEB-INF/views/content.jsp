...
<div class="easyui-panel" title="Nested Panel" data-options="width:'100%',minHeight:500,noheader:true,border:false" style="padding:10px;">
    <div class="easyui-layout" data-options="fit:true">
		...
		<div id="contentEditForm" class="easyui-window" title="编辑商品" data-options="modal:true,closed:true,iconCls:'icon-save',url:'/content-edit" style="width:80%;height:80%;padding:10px;">
        </div>
    </div>
</div>
...
// 		alert(data);
//     	$('#contentEditForm').window('refresh', '/content-edit?contentId='+data.id).window("open");
